package com.zhangle.common.util;
...
import static com.zhangle.common.util.StringUtil.lineToHump;
...
public class MybatisGeneratorUtil {
	...
	public static void generator(
		...
		try {
			...
			targetProjectSqlMap=targetProjectSqlMap.replace("zheng-upms-dao/build/classes/main/zheng-upms/", "");
			targetProject=targetProject.replace("zheng-upms-dao/build/classes/main/zheng-upms/", "");
